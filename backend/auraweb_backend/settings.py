"""
Django settings for auraweb_backend project.
...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'django-insecure-t+ka46@8@8la37!(fwx2lhp_tpmy@*oeztr)zym-+t8*6!jc7e')
...
ROOT_URLCONF = 'auraweb_backend.urls'
...
WSGI_APPLICATION = 'auraweb_backend.wsgi.application'
...
DATABASES = {
    'default': dj_database_url.config(
        default='postgresql://postgres:1234@localhost:5432/auraweb_db',
        conn_max_age=600
    )
}
...
# CORS Config
# Allow configured origins or the Render hostname
CORS_ALLOWED_ORIGINS = os.environ.get('CORS_ALLOWED_ORIGINS', '').split(',') if os.environ.get('CORS_ALLOWED_ORIGINS') else []

# In production, allow the Render hostname
...
DEFAULT_FROM_EMAIL = os.environ.get('DEFAULT_FROM_EMAIL', 'AuraWeb Solutions <noreply@auraweb.com>')
